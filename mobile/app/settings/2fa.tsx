...
export default function TwoFactorScreen() {
  ...
  return (
    <ScreenShell title={t('settings.twoFactor')} keyboard>
      {/* Status card */}
      <View style={{ marginTop: 12, backgroundColor: p.bgElev, borderRadius: 18, borderWidth: 1, borderColor: p.border, padding: 18, flexDirection: 'row', alignItems: 'center', gap: 14 }}>
