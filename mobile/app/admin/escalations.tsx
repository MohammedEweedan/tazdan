    ...
    <View style={{ flex: 1, backgroundColor: p.bg }}>
      ...
      <SafeAreaView style={{ flex: 1 }} edges={['top']}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 12, paddingHorizontal: 16, paddingTop: 8, paddingBottom: 12 }}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={{ color: p.fg, fontSize: 18, fontWeight: '800', letterSpacing: -0.3 }}>Escalations</Text>
        ...
        <Modal visible={!!resolving} animationType="slide" transparent onRequestClose={() => setResolving(null)}>
          <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.55)', justifyContent: 'flex-end' }}>
            <View style={{ backgroundColor: p.bg, borderTopLeftRadius: 28, borderTopRightRadius: 28, padding: 20, paddingBottom: 36 }}>
              ...
              <Text style={{ color: p.fgFaint, fontSize: 10, fontWeight: '800', letterSpacing: 0.6, marginBottom: 6 }}>
                RESOLUTION NOTE
              </Text>
              ...
              <View style={{ flexDirection: 'row', gap: 10 }}>
                ...
                >
                  <Text style={{ color: p.ctaFg, fontWeight: '800' }}>
    ...
    <View style={{
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 8 }}>
        <View style={{ paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, backgroundColor: sc.bg }}>
          <Text style={{ color: sc.fg, fontSize: 10, fontWeight: '800', letterSpacing: 0.6 }}>{status}</Text>
        </View>
        {e.tradeId && (
          <View style={{ paddingHorizontal: 8, paddingVertical: 3, borderRadius: 6, backgroundColor: p.pillBg }}>
            <Text style={{ color: p.fgMuted, fontSize: 10, fontWeight: '800', letterSpacing: 0.4 }}>P2P TRADE</Text>
          </View>
        )}
      ...
      <Text style={{ color: p.fg, fontSize: 15, fontWeight: '800', marginBottom: 4 }}>
        {e.reason}
      </Text>
      {!!e.details && (
      ...
      <View style={{ flexDirection: 'row', gap: 12, marginTop: 6, paddingTop: 10, borderTopWidth: 1, borderTopColor: p.border }}>
        <View style={{ flex: 1 }}>
          <Text style={{ color: p.fgFaint, fontSize: 9, fontWeight: '800', letterSpacing: 0.6 }}>RAISED BY</Text>
        ...
        <View style={{ flex: 1 }}>
          <Text style={{ color: p.fgFaint, fontSize: 9, fontWeight: '800', letterSpacing: 0.6 }}>COUNTERPARTY</Text>
          <Text style={{ color: p.fg, fontSize: 13, fontWeight: '700', marginTop: 2 }}>
      ...
      {!isResolved && (
        <View style={{ flexDirection: 'row', gap: 8, marginTop: 12 }}>
          ...
          >
            <Text style={{ color: '#fff', fontSize: 12, fontWeight: '800' }}>Resolve</Text>
          </Pressable>
        </View>
      )}
      ...
      {isResolved && e.resolutionNote && (
        <View style={{ marginTop: 10, padding: 10, borderRadius: 10, backgroundColor: 'rgba(34,197,94,0.08)', borderWidth: 1, borderColor: 'rgba(34,197,94,0.20)' }}>
          <Text style={{ color: '#22c55e', fontSize: 11, fontWeight: '800', letterSpacing: 0.5 }}>RESOLVED</Text>
