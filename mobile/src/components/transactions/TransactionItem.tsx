...
const ICON_FOR: Record<TxType, { name: keyof typeof Ionicons.glyphMap; color: string; bg: string }> = {
  ...
  BUY:        { name: 'add',            color: '#4A8FE0', bg: 'rgba(74,143,224,0.18)' },
  ...
  TOPUP:      { name: 'card',           color: '#4A8FE0', bg: 'rgba(74,143,224,0.18)' },
  P2P_BUY:    { name: 'people',         color: '#4A8FE0', bg: 'rgba(74,143,224,0.18)' },
