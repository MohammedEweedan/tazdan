...
export type PaymentMethodId =
  ...
  | 'LYD_AGENT'         // Cash deposit via fortuni agent network (Libya)
...
export const METHOD_CATALOGUE: Record<PaymentMethodId, PaymentMethod> = {
  ...
  BANK_TRANSFER: {
    id: 'BANK_TRANSFER',
    name: 'Bank Transfer',
    description: 'Send from your bank to fortuni. No card fees.',
  ...
  P2P: {
    ...
    description: 'Buy USDT/LYD from another verified fortuni user.',
