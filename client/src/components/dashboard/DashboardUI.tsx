...
export function useDashboardTokens() {
  ...
  return {
    ...
    panelBorder: dark ? "rgba(255,255,255,0.06)" : "rgba(99,161,219,0.08)",
    panelInner: dark ? "rgba(255,255,255,0.02)" : "rgba(99,161,219,0.03)",
    ...
    hover: dark ? "rgba(255,255,255,0.04)" : "rgba(99,161,219,0.04)",
    success: "#22c55e",
    danger: "#ef4444",
    warning: "#f59e0b",
  };
...
export function GlassCard({
  ...
  return (
    <Box
      ...
      boxShadow={t.dark ? "0 10px 30px rgba(0,0,0,0.25)" : "0 6px 20px rgba(99,161,219,0.05)"}
      transition="all 0.2s cubic-bezier(0.2,0.8,0.2,1)"
      _hover={hover ? { borderColor: t.brand, transform: "translateY(-1px)", boxShadow: `0 14px 40px ${t.dark ? "rgba(99,161,219,0.2)" : "rgba(99,161,219,0.1)"}` } : undefined}
      {...rest}
    >
      {children}
    </Box>
