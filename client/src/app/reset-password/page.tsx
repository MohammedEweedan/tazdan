...
export default function ResetPasswordPage() {
  ...
  const strengthColor = ["#ef4444", "#f59e0b", "#63a1db", "#22c55e"][strength - 1] || "transparent";
      ...
      <Box maxW="420px" w="100%">
        ...
        <Box bg="#1a1d27" border="1px solid rgba(255,255,255,0.08)" borderRadius="20px" p="32px">
                ...
                <Box mb="16px">
                  <InputGroup>
                    <Input
                      ...
                      fontSize="15px"
                      pr="48px"
                      _focus={{ borderColor: "#63a1db", boxShadow: "none" }}
                    />
                    <IconButton
          ...
          <Flex align="center" justify="center" mt="24px" gap="6px">
            ...
            <Box as="button" onClick={() => router.push("/login")} color="#63a1db" fontSize="14px" fontWeight="700" textDecoration="none">
              Back to Login
            </Box>
          </Flex>
        </Box>
