...
function Comparison() {
  ...
  const rows = [
    { feature: t("biz_cmp_r1"), bank: t("biz_cmp_r1_bank"), tazdan: t("biz_cmp_r1_us") },
    { feature: t("biz_cmp_r2"), bank: t("biz_cmp_r2_bank"), tazdan: t("biz_cmp_r2_us") },
    { feature: t("biz_cmp_r3"), bank: t("biz_cmp_r3_bank"), tazdan: t("biz_cmp_r3_us") },
    { feature: t("biz_cmp_r4"), bank: t("biz_cmp_r4_bank"), tazdan: t("biz_cmp_r4_us") },
    { feature: t("biz_cmp_r5"), bank: t("biz_cmp_r5_bank"), tazdan: t("biz_cmp_r5_us") },
  ];
          ...
          >
            ...
            <VStack spacing={7} position="relative" zIndex={1} align="start" maxW="640px">
              ...
              <HStack spacing={3} flexWrap="wrap" pt={1}>
                ...
                <NextLink href={`mailto:business@tazdan.com`} passHref legacyBehavior>
                  <HStack as="a" spacing={2} px={5} h="50px" borderRadius="13px"
                  ...
                  >
                    <Text fontWeight="700" fontSize="14px">business@tazdan.com</Text>
                  </HStack>
                </NextLink>
              </HStack>
            </VStack>
